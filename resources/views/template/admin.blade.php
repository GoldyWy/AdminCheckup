...
<head>
  ...
  <title>Laboratorium Checkup - Dashboard</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item" id="menu-checkup">
        <a class="nav-link" href="{{ url('superadmin/jnscheckup') }}">
          <i class="fas fa-fw fa-users"></i>
          <span>Jenis Checkup</span></a>
      </li>
      @endif

      @if(Session::get('role') == "admin")
      <li class="nav-item" id="menu-pasien">
        <a class="nav-link" href="{{ url('admin/pasien') }}">
          <i class="fas fa-fw fa-users"></i>
          <span>Pasien</span></a>
      </li>
      <li class="nav-item" id="menu-pembayaran">
      ...
      <li class="nav-item" id="menu-antrian">
        <a class="nav-link" href="{{ url('pegawai/antrian') }}">
